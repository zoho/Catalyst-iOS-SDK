...
public class ZCatalystApp
{
    ...
    internal var appConfig : ZCatalystAppConfiguration!
    ...
    public func initSDK( window : UIWindow ) throws
    {
        guard let appConfigPlist = Bundle.main.path( forResource : "AppConfiguration", ofType : "plist" ), let appConfig = NSDictionary( contentsOfFile : appConfigPlist ) as? [String : Any] else
        {

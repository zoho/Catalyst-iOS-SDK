...
//{
//    @discardableResult
//    func staticrequest(_ route: APIEndPointConvertable, session:URLSession, completion: @escaping (Result<Data, RouterError>) -> Void) -> URLSessionTask?
//
//    func static download(_ url: APIEndPointConvertable,
//                  progress: @escaping DownloadProgressBlock,
//                  downloadFilePath: @escaping DownloadTaskFilePath,
//                  completion: @escaping DownloadCompletionBlock
//    )
//    func static upload(_ url: APIEndPointConvertable,
//                progress: @escaping UploadProgressBlock,
//                completion: @escaping UploadCompletionBlock
//    )
//}

//public struct Parker:NetworkRequestable
//{
//    @discardableResult
//    public static func request(_ route: APIEndPointConvertable, session:URLSession = URLSession.shared, completion: @escaping (Result<Data, RouterError>) -> Void) -> URLSessionTask?
//    {
//        return Router.request(route, session: session, completion: completion)
//    }
//    
//    public static func download(_ url: APIEndPointConvertable,
//                                progress: @escaping DownloadProgressBlock,
//                                downloadFilePath: @escaping DownloadTaskFilePath,
//                                completion: @escaping DownloadCompletionBlock
//                                )
//    {
//        Router.downloadRequest(url, downloadedFilePath: downloadFilePath, downloadCompletionBlock: completion, progress: progress)
//    }
//    
//    public static func upload(_ url: APIEndPointConvertable,
//                              progress: @escaping UploadProgressBlock,
//                              completion: @escaping UploadCompletionBlock
//                              )
//    {
//        Router.uploadRequest(url, uploadCompletionBlock: completion, progress: progress)
//    }
//    
//}
